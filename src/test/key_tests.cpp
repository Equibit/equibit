...
static const std::string strSecret1 = "5JERFZm3S4J6rJKFjqgD4giHffF34cUsPsJR9EgCZdJvw4VDejo";
static const std::string strSecret2 = "5K494XZwps2bGyeL71pWid4noiSNA2cfCibrvRWqcHSptoFn7rc";
static const std::string strSecret1C = "Ky4E3HbPjbYUpbRa45r4FGHEZdnx6wc1Rw1sZMN231G93Gaif5ku";
static const std::string strSecret2C = "L2graZvQzFp2HX1mKYciAiBjBBtxNr8PcicsLoChYjazPamsaNij";
static const std::string addr1 = "EQaHGDPRek8b7h8vG7sLhGPRZ5KBUct58tbx";
static const std::string addr2 = "EQaT4ygwPnnPgbrAowANt3wqCKpnMDxeU2Jk";
static const std::string addr1C = "EQaKwV324PVKzytzqEiwsQNz3NazNVkCCZKn";
static const std::string addr2C = "EQaG8CBE4TiTcLrKG9aUiWLTycv5VSTe8K28";

static const std::string strAddressBad = "EQaHGDPRek8b7h8vG7sLhGPRZ5KBUct58tbb";
#endif // END_BUILD
